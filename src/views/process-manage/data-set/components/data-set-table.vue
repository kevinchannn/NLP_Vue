<template>
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.importance" placeholder="归属者" clearable style="width: 90px" class="filter-item">
    ...
    >
      ...
      <el-table-column label="归属者" width="100px" align="center">
        <template slot-scope="{row}">
      ...
      <el-table-column label="任务类型" width="160px" align="center">
        <template slot-scope="{row}">
